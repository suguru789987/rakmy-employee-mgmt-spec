...
| **受入条件表**（32条件） | https://suguru789987.github.io/rakmy-employee-mgmt-spec/acceptance.html | `20260803_02_従業員管理_受入条件表.tsv` |
| **検証プラン（操作系・66件）** | https://suguru789987.github.io/rakmy-employee-mgmt-spec/test-plan-ops.html | `20260803_03a_従業員管理_検証プラン_操作系.tsv` |
| **検証プラン（計算系・20件）** | https://suguru789987.github.io/rakmy-employee-mgmt-spec/test-plan-calc.html | `20260803_03b_従業員管理_検証プラン_計算系.tsv` |
