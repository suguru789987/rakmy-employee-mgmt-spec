var options = {
	series: [{
		name: '売上合計',
		type: "bar",
		data: [748562, 659758, 624328, 542186, 453972, 423322, 325496, 313632, 245681, 215235, 193313, 175424, 164382, 151314, 142314, 103314, 58765, 54121, 23654, 12548]
		}, {
		name: '累計構成比',
	    type: 'line',
...
var analysisChartAbc = new ApexCharts(document.querySelector("#chart_analysis_abc_revenue"), options);
